...
**安装好kubeadm等相关工具后，接着在master虚拟机上执行以下操作：使用下面这条命令启动 master**
      ...
      配置含义如下：
       ...
       启动成功后，你会看到类似如下提示:
            ...
            <a href="https://ibb.co/C8ksWpm"><img src="https://i.ibb.co/9gF3Gmc/kubeadm-token-number.jpg" alt="kubeadm-token-number" border="0"></a>
